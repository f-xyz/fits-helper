...
TEST(StringFormat, formatNumber_positive) {
  // act
  auto result = astroutils::string::formatNumber(3.14159, 2);
  // assert
...
TEST(StringFormat, formatNumber_negative) {
  // act
  auto result = astroutils::string::formatNumber(-12.3456, 2);
  // assert
...
TEST(StringFormat, formatNumber_zero) {
  // act
  auto result = astroutils::string::formatNumber(0.0, 2);
  // assert
...
TEST(StringFormat, formatNumber_customPrecision) {
  // act
  auto resultHighPrec = astroutils::string::formatNumber(1.23456, 4);
  auto resultZeroPrec = astroutils::string::formatNumber(42.0, 0);
  // assert
