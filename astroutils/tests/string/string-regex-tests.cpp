...
TEST(StringRegex, regex_fullMatch) {
  ...
  // act
  auto result = astroutils::string::regex(rx, input);
  // assert
...
TEST(StringRegex, regex_captureGroups) {
  ...
  // act
  auto fullMatch = astroutils::string::regex(rx, input, 0);
  auto group1 = astroutils::string::regex(rx, input, 1);
  auto group2 = astroutils::string::regex(rx, input, 2);
  auto outOfBounds = astroutils::string::regex(rx, input, 3);
  // assert
...
TEST(StringRegex, replace) {
  ...
  std::string input = "qwe123asd";
  // act
  auto result = astroutils::string::regex_replace(rx, input, "###");
  // assert
